  ...
  return (
    <Modal animationType="slide" transparent visible={visible} onRequestClose={onClose}>
      <View style={styles.container}>
        ...
        {/* Center Scanner Viewfinder Overlay */}
        <View style={styles.viewfinderContainer}>
          ...
          <Text style={styles.instructionText}>
            Align the QR code within the frame to automatically scan unit or property details
          </Text>
        ...
        <View style={styles.shortcutSection}>
          ...
          <View style={styles.shortcutRow}>
            <TouchableOpacity
              ...
              onPress={() => handleSimulateScan('/command-center')}
              activeOpacity={0.7}
            >
              <MaterialIcons name="apartment" size={16} color="#00D8F6" />
              <Text style={styles.shortcutText}>Unit #104</Text>
            </TouchableOpacity>

            <TouchableOpacity
              style={styles.shortcutChip}
              onPress={() => handleSimulateScan('/leases')}
              activeOpacity={0.7}
            >
              <MaterialIcons name="receipt-long" size={16} color="#00D8F6" />
              <Text style={styles.shortcutText}>Lease QR</Text>
            </TouchableOpacity>

            <TouchableOpacity
              style={styles.shortcutChip}
              onPress={() => handleSimulateScan('/expenses')}
              activeOpacity={0.7}
            >
              <MaterialIcons name="payments" size={16} color="#00D8F6" />
              <Text style={styles.shortcutText}>Payment Code</Text>
            </TouchableOpacity>
          </View>
        </View>
      </View>
