package com.tenantliving.unit.controller;
...
public class UnitController {
    ...
    public ResponseEntity<ApiResponse<List<UnitDTOs.UnitResponse>>> getFloorLayout(
        ...
        List<UnitDTOs.UnitResponse> layout = unitService.getFloorLayout(propertyId, floorNumber);
    ...
    public ResponseEntity<ApiResponse<List<UnitDTOs.UnitResponse>>> saveFloorLayout(
        ...
        List<UnitDTOs.UnitResponse> saved = unitService.saveFloorLayout(propertyId, floorNumber, items);
