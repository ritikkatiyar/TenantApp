...
public class AnalyticsRepository {
    ...
    public Object[] getRevenueMetrics(List<UUID> propertyIds, String billingMonth) {
        ...
        query.setParameter("statusPaid", com.livic.common.domain.RentCycleStatus.PAID);
    ...
    public List<Object[]> getDefaulters(List<UUID> propertyIds) {
        ...
        query.setParameter("propertyIds", propertyIds);
        query.setParameter("statusOverdue", com.livic.common.domain.RentCycleStatus.OVERDUE);
        query.setParameter("statusPending", com.livic.common.domain.RentCycleStatus.PENDING);
    ...
    public List<Object[]> getOccupancyByProperty(List<UUID> propertyIds) {
        ...
        Query query = entityManager.createQuery(jpql);
        query.setParameter("propertyIds", propertyIds);
        query.setParameter("statusActive", com.livic.common.domain.LeaseStatus.ACTIVE);
