...
const createStyles = (theme: any, isDark: boolean) => StyleSheet.create({
  ...
  scrollDesktop: { padding: theme.Spacing.xl, maxWidth: 1280, width: '100%', alignSelf: 'center' },
  ...
  searchBox: {
    ...
    borderWidth: 1, borderColor: 'rgba(0,0,0,0.07)', paddingHorizontal: 12, gap: theme.Spacing.sm,
  },
  ...
  tab: {
    ...
    height: 40, paddingHorizontal: theme.Spacing.md, borderRadius: 20,
