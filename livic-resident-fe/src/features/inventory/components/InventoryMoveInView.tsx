...
const styles = StyleSheet.create({
  ...
  progressSublabel: { fontSize: 11, color: 'rgba(255,255,255,0.7)', fontWeight: '600', fontFamily: 'Inter' },
  ...
  ghostBtnText: { fontSize: 12, fontWeight: '700', color: '#5b6b6d', fontFamily: 'Inter' },
