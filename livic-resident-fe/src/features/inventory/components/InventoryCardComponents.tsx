...
const createStyles = (theme: any, isDark: boolean) => StyleSheet.create({
  ...
  verifyCard: { borderRadius: 18, borderWidth: 1, borderColor: 'rgba(255,255,255,0.85)', backgroundColor: 'rgba(255,255,255,0.35)', overflow: 'hidden', padding: theme.Spacing.md, gap: 14 },
